...
adds encrypted persistent sign-in, restart recovery and AI preparation, with 29
focused tests. The [private hosted preview](https://blaise-buyer-workspace.onrender.com)
passed live sign-in, buyer retrieval, AI drafting and server-restart recovery;
final phone and hosted write/renewal acceptance remain open.
